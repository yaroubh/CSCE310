 ...
 * This code allows admins to create reviews and returns errors if the hotel/username doesn't exist.
 */
?>
<link rel="stylesheet" href="style.css">
<div id = "review-button">
    <a href="hotel_reviews_admin.php" class="btn btn-primary">Back to Review</a>
</div>
